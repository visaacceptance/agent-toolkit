 ...
 */
function searchMcpTransactions() {
    return __awaiter(this, void 0, void 0, function () {
        var client, command, transport, query, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    query = "submitTimeUtc:[NOW/DAY-14DAYS TO NOW/DAY+1DAY]";
                    return [4 /*yield*/, client.callTool({
                            name: "search_transactions",
                            arguments: { query: 'submitTimeUtc:[now-14d TO now]' }
                        })];
                case 2:
                    response = _a.sent();
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error("Error calling search_transactions:", error_1);
                    return [3 /*break*/, 4];
